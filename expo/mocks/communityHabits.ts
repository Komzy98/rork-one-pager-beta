...
const buildSplitWeeks = (): ProgramWeek[] => {
  const weekTemplates: Array<{ title: string; description: string; chest: string[]; back: string[]; legs: string[]; shoulders: string[]; notes: Record<string, string> }> = [
    {
      title: 'Week 2 - Build the 4x4 Base',
      description: 'Same 4x4 structure on main lifts. Add quality accessory volume.',
      chest: ['Barbell Bench Press: 4x4 @ 75% 1RM', 'Incline Dumbbell Press: 3x8', 'Cable Fly: 3x12', 'Tricep Pushdown: 3x12', 'Overhead Rope Extension: 3x10'],
      back: ['Barbell Row: 4x4 @ 75% 1RM', 'Pull-ups: 4x8', 'Seated Cable Row: 3x10', 'Face Pull: 3x15', 'Barbell Curl: 3x10', 'Hammer Curl: 3x12'],
      legs: ['Back Squat: 4x4 @ 75% 1RM', 'Romanian Deadlift: 3x8', 'Leg Press: 3x10', 'Leg Curl: 3x12', 'Standing Calf Raise: 4x12'],
      shoulders: ['Overhead Press: 4x4 @ 72% 1RM', 'Lateral Raise: 4x12', 'Face Pull: 3x15', 'Skull Crushers: 3x10', 'Incline Dumbbell Curl: 3x10', 'Hanging Leg Raise: 3x12'],
      notes: { chest: 'Leave 1-2 reps in reserve on bench. Triceps pair with chest for stronger pressing.', back: 'Row heavy, then curl fresh — biceps belong with back.', legs: 'Brace hard on every squat rep. Rest 2-3 min on 4x4 sets.', shoulders: 'Arm day bridge: shoulders first, then direct bicep/tricep work.' },
    },
    {
      title: 'Week 3 - First Weight Jump',
      description: 'Add 5 lbs to upper 4x4 lifts, 10 lbs to squat when all sets are clean.',
      chest: ['Barbell Bench Press: 4x4 @ 77% 1RM', 'Incline Dumbbell Press: 3x8', 'Cable Fly: 3x12', 'Skull Crushers: 3x10', 'Tricep Pushdown: 3x12'],
      back: ['Deadlift: 4x4 @ 77% 1RM', 'Pull-ups: 4x8', 'Barbell Row: 3x8', 'Seated Cable Row: 3x10', 'Barbell Curl: 3x10', 'Incline Dumbbell Curl: 3x10'],
      legs: ['Back Squat: 4x4 @ 77% 1RM', 'Romanian Deadlift: 3x8', 'Bulgarian Split Squat: 3x10 each leg', 'Leg Curl: 3x12', 'Standing Calf Raise: 4x12'],
      shoulders: ['Overhead Press: 4x4 @ 75% 1RM', 'Lateral Raise: 4x12', 'Rear Delt Fly: 3x12', 'Skull Crushers: 3x10', 'Hammer Curl: 3x10', 'Cable Crunch: 3x12'],
      notes: { chest: 'Focus on bar path. Add weight only when all 4 sets hit 4 reps.', back: 'Reset each deadlift rep. No bounce.', legs: 'Squat depth is non-negotiable as weight climbs.', shoulders: 'OHP progresses slowly — micro-plates count.' },
    },
    {
      title: 'Week 4 - Deload Lite',
      description: 'Drop to 3x4 on main lifts at the same intensity. Recovery week.',
      chest: ['Barbell Bench Press: 3x4 @ 77% 1RM', 'Incline Dumbbell Press: 2x8', 'Cable Fly: 2x12', 'Tricep Pushdown: 2x12'],
      back: ['Deadlift: 3x4 @ 75% 1RM', 'Pull-ups: 3x6', 'Seated Cable Row: 2x10', 'Barbell Curl: 2x10'],
      legs: ['Back Squat: 3x4 @ 77% 1RM', 'Romanian Deadlift: 2x8', 'Leg Curl: 2x12', 'Standing Calf Raise: 3x12'],
      shoulders: ['Overhead Press: 3x4 @ 75% 1RM', 'Lateral Raise: 3x12', 'Face Pull: 2x15', 'Incline Dumbbell Curl: 2x10'],
      notes: { chest: 'Sharp reps. You should feel fresh leaving the gym.', back: 'Light pulls — focus on lat engagement.', legs: 'Quality squats, full recovery between sets.', shoulders: 'Skip failure. Save joints for the next block.' },
    },
    {
      title: 'Week 5 - Heavier 4x4',
      description: 'Phase 2 begins. Bump main-lift percentages and keep accessories moderate.',
      chest: ['Barbell Bench Press: 4x4 @ 80% 1RM', 'Incline Dumbbell Press: 3x8', 'Cable Fly: 3x12', 'Close-Grip Bench: 3x8', 'Tricep Pushdown: 3x12'],
      back: ['Deadlift: 4x4 @ 80% 1RM', 'Pull-ups: 4x6-8', 'T-Bar Row: 3x8', 'Seated Cable Row: 3x10', 'Barbell Curl: 3x8', 'Hammer Curl: 3x10'],
      legs: ['Back Squat: 4x4 @ 80% 1RM', 'Romanian Deadlift: 3x8', 'Leg Press: 3x10', 'Walking Lunges: 3x10 each leg', 'Leg Curl: 3x12', 'Standing Calf Raise: 4x12'],
      shoulders: ['Overhead Press: 4x4 @ 78% 1RM', 'Lateral Raise: 4x12', 'Face Pull: 3x15', 'Skull Crushers: 3x8', 'Incline Dumbbell Curl: 3x10', 'Hanging Leg Raise: 3x10'],
      notes: { chest: 'Heavy 4x4 bench. Rest 3 min between working sets.', back: 'Pull with elbows, not hands. Deadlift stays crisp.', legs: 'Squat sets should feel challenging but repeatable.', shoulders: 'Strict OHP — no push press on 4x4 sets.' },
    },
    {
      title: 'Week 6 - Volume Peak',
      description: 'Peak block volume. Main lifts stay 4x4; accessories get one extra set.',
      chest: ['Barbell Bench Press: 4x4 @ 82% 1RM', 'Incline Dumbbell Press: 4x8', 'Cable Fly: 3x12', 'Skull Crushers: 3x10', 'Tricep Pushdown: 4x12'],
      back: ['Deadlift: 4x4 @ 82% 1RM', 'Pull-ups: 4x6-8', 'T-Bar Row: 4x8', 'Seated Cable Row: 3x10', 'Barbell Curl: 4x8', 'Preacher Curl: 3x10'],
      legs: ['Back Squat: 4x4 @ 82% 1RM', 'Romanian Deadlift: 4x8', 'Leg Press: 3x10', 'Bulgarian Split Squat: 3x10 each leg', 'Leg Curl: 3x12', 'Standing Calf Raise: 4x12'],
      shoulders: ['Overhead Press: 4x4 @ 80% 1RM', 'Lateral Raise: 4x12', 'Rear Delt Fly: 3x12', 'Skull Crushers: 3x10', 'Incline Dumbbell Curl: 3x10', 'Cable Crunch: 3x12'],
      notes: { chest: 'Highest bench stress so far. Use a spotter on top sets.', back: 'Deadlift 4x4 — warm up thoroughly.', legs: 'Expect leg soreness. Eat and sleep big this week.', shoulders: 'Arm pump day after heavy pressing/pulling all week.' },
    },
    {
      title: 'Week 7 - Progressive Push',
      description: 'Push main-lift percentages. Hardest training week of the accumulation block.',
      chest: ['Barbell Bench Press: 4x4 @ 85% 1RM', 'Incline Dumbbell Press: 3x6-8', 'Cable Fly: 3x10', 'Close-Grip Bench: 3x6', 'Tricep Pushdown: 3x12'],
      back: ['Deadlift: 4x4 @ 85% 1RM', 'Pull-ups: 4x6 (add weight if needed)', 'T-Bar Row: 4x6', 'Seated Cable Row: 3x10', 'Barbell Curl: 3x8', 'Hammer Curl: 3x10'],
      legs: ['Back Squat: 4x4 @ 85% 1RM', 'Romanian Deadlift: 3x8', 'Leg Press: 3x8', 'Leg Curl: 3x12', 'Standing Calf Raise: 4x10', 'Seated Calf Raise: 3x12'],
      shoulders: ['Overhead Press: 4x4 @ 82% 1RM', 'Lateral Raise: 4x12', 'Face Pull: 3x15', 'Skull Crushers: 3x8', 'Incline Dumbbell Curl: 3x8', 'Hanging Leg Raise: 3x10'],
      notes: { chest: 'Heaviest bench week. Leave one rep in reserve.', back: 'Mixed grip on heavy deadlift sets is fine.', legs: 'Rest 3 min between squat 4x4 sets.', shoulders: 'OHP PR opportunity if bar speed stays fast.' },
    },
    {
      title: 'Week 8 - Mini Deload',
      description: 'Cut to 3x4 on compounds. Stay sharp before intensification.',
      chest: ['Barbell Bench Press: 3x4 @ 82% 1RM', 'Incline Dumbbell Press: 2x8', 'Tricep Pushdown: 2x12', 'Close-Grip Bench: 2x8'],
      back: ['Deadlift: 3x4 @ 80% 1RM', 'Pull-ups: 3x6', 'T-Bar Row: 2x8', 'Barbell Curl: 2x8'],
      legs: ['Back Squat: 3x4 @ 82% 1RM', 'Romanian Deadlift: 2x8', 'Leg Curl: 2x12', 'Standing Calf Raise: 3x12'],
      shoulders: ['Overhead Press: 3x4 @ 80% 1RM', 'Lateral Raise: 3x12', 'Skull Crushers: 2x10', 'Incline Dumbbell Curl: 2x10'],
      notes: { chest: 'Fast bar speed on every rep.', back: 'Feel strong, not smashed.', legs: 'Full depth, crisp reps.', shoulders: 'Light arm work — elbows will thank you.' },
    },
    {
      title: 'Week 9 - Intensification Begins',
      description: 'Heavy 4x4 phase. Lower accessory reps, higher main-lift focus.',
      chest: ['Barbell Bench Press: 4x4 @ 87% 1RM', 'Incline Dumbbell Press: 3x6-8', 'Chest Dip: 3x8 (add weight)', 'Skull Crushers: 3x8', 'Tricep Pushdown: 3x10'],
      back: ['Deadlift: 4x4 @ 87% 1RM', 'Pull-ups: 4x6 (weighted)', 'Barbell Row: 3x6', 'Seated Cable Row: 3x10', 'Barbell Curl: 3x8', 'Hammer Curl: 3x8'],
      legs: ['Back Squat: 4x4 @ 87% 1RM', 'Front Squat: 3x5', 'Leg Press: 3x8', 'Leg Curl: 3x10', 'Standing Calf Raise: 4x10'],
      shoulders: ['Overhead Press: 4x4 @ 85% 1RM', 'Lateral Raise: 3x12', 'Face Pull: 3x15', 'Skull Crushers: 3x8', 'Incline Dumbbell Curl: 3x8', 'Ab Wheel: 3x10'],
      notes: { chest: '4x4 sets should feel heavy but controlled.', back: 'Stay tight on every deadlift rep.', legs: 'Front squat builds squat positioning strength.', shoulders: 'Micro-plates on OHP if needed.' },
    },
    {
      title: 'Week 10 - Strength Peak',
      description: 'Top 4x4 sets plus a heavy single on main lifts.',
      chest: ['Barbell Bench Press: 1x3 @ 90%, 3x4 @ 82% 1RM', 'Incline Dumbbell Press: 3x6', 'Chest Dip: 3x8 (weighted)', 'Skull Crushers: 3x8', 'Tricep Pushdown: 3x10'],
      back: ['Deadlift: 1x2 @ 90%, 3x4 @ 82% 1RM', 'Pull-ups: 4x6 (weighted)', 'T-Bar Row: 3x6', 'Seated Cable Row: 3x10', 'Barbell Curl: 3x8', 'Preacher Curl: 3x8'],
      legs: ['Back Squat: 1x3 @ 90%, 3x4 @ 82% 1RM', 'Front Squat: 3x5', 'Leg Press: 3x8', 'Leg Curl: 3x10', 'Standing Calf Raise: 4x10'],
      shoulders: ['Overhead Press: 1x3 @ 90%, 3x4 @ 82% 1RM', 'Lateral Raise: 3x12', 'Face Pull: 3x15', 'Skull Crushers: 3x8', 'Incline Dumbbell Curl: 3x8', 'Cable Crunch: 3x12'],
      notes: { chest: 'Bench top set — have a spotter ready.', back: 'Heavy double on deadlift. Fast off the floor.', legs: 'Squat heavy, rest fully, squat heavy again.', shoulders: 'OHP PR week for many lifters.' },
    },
    {
      title: 'Week 11 - Peak Intensity',
      description: 'Maximum loads on top sets. Back-off 4x4 stays submaximal.',
      chest: ['Barbell Bench Press: 1x2 @ 92%, 2x4 @ 85% 1RM', 'Incline Dumbbell Press: 3x6', 'Cable Fly: 3x12', 'Skull Crushers: 3x8', 'Tricep Pushdown: 3x10'],
      back: ['Deadlift: 1x1 @ 92%, 2x4 @ 85% 1RM', 'Pull-ups: 4x6 (weighted)', 'Barbell Row: 3x6', 'Seated Cable Row: 3x10', 'Barbell Curl: 3x8', 'Hammer Curl: 3x10'],
      legs: ['Back Squat: 1x2 @ 92%, 2x4 @ 85% 1RM', 'Front Squat: 3x5', 'Leg Press: 3x10', 'Leg Curl: 3x12', 'Standing Calf Raise: 4x12'],
      shoulders: ['Overhead Press: 1x2 @ 92%, 2x4 @ 85% 1RM', 'Lateral Raise: 4x12', 'Face Pull: 3x15', 'Skull Crushers: 3x8', 'Incline Dumbbell Curl: 3x8', 'Hanging Leg Raise: 3x10'],
      notes: { chest: 'Heaviest bench of the program. Earn it.', back: 'Singles should feel fast, not grindy.', legs: 'Peak squat load — belt up if you use one.', shoulders: 'Finish strong. Arms should feel pumped, not wrecked.' },
    },
    {
      title: 'Week 12 - Testing Week',
      description: 'Light technique days early in the week, then test new 1RMs.',
      chest: ['Warmup: Barbell Bench 3x5 light', 'Test Bench 1RM (work up in singles)', 'Incline Dumbbell Press: 3x8 (moderate)', 'Tricep Pushdown: 3x12'],
      back: ['Warmup: Deadlift 3x3 light', 'Test Deadlift 1RM (work up singles)', 'Pull-ups: 3x AMRAP', 'Barbell Curl: 3x8'],
      legs: ['Warmup: Squat 3x3 light', 'Test Squat 1RM (work up singles)', 'Leg Press: 3x8 moderate', 'Standing Calf Raise: 3x12'],
      shoulders: ['Warmup: OHP 3x3 light', 'Test Overhead Press 1RM', 'Lateral Raise: 3x12', 'Skull Crushers: 3x10 light'],
      notes: { chest: 'Have a spotter. Film your PR attempt.', back: 'Belt and straps for max effort if you use them.', legs: 'Squat PR day. Go deep.', shoulders: 'Strict OHP test — no push press.' },
    },
  ];
  ...
  return weekTemplates.map((tpl, index) => ({
    ...
    days: [
      ...
      { day: 5, title: 'Day 4 - Arms & Shoulders', description: 'Dedicated arm work plus delts — the middle-ground finisher day', duration: '55-65 min', activities: tpl.shoulders, notes: tpl.notes.shoulders },
...
export const COMMUNITY_HABITS: CommunityHabit[] = [
  ...
  },
  {
    ...
    mainGoal: 'Hit 10,000 steps daily and build lifelong cardio endurance',
    longDescription: 'Walking is the most underrated exercise on the planet. 10,000 steps burns ~400-500 kcal, lowers blood pressure, improves mood, and adds years to your life. This 4-week ramp builds from wherever you are today to a sustainable 10K/day.',
    benefits: [
      'Burn 400-500 kcal per day without a gym',
      'Lower resting heart rate within 2-3 weeks',
      'Reduce risk of heart disease by up to 30%',
      'Boost mood and creativity (Stanford walking study)',
      'Improve sleep quality and deep sleep minutes',
      'Protect knees and hips with low-impact movement',
    ],
    equipment: ['Comfortable walking shoes', 'Fitness tracker or phone step counter', 'Water bottle', 'Optional: podcasts or audiobooks'],
    prerequisites: ['None - walking is safe for almost everyone', 'Start from your current baseline, not zero', 'Comfortable walking shoes to prevent blisters'],
    scientificBacking: 'JAMA Internal Medicine (2019): 7,500-10,000 steps/day significantly reduces all-cause mortality in adults. Harvard study: walking 30+ min/day cuts cardiovascular risk by 30%.',
    programLength: '4 weeks',
    phases: [
      { phase: 1, title: 'Ramp Up', description: 'Build from baseline to 7K steps/day', weeks: [1, 2], focusAreas: ['Consistency', 'Foot care', 'Finding walking windows'] },
      { phase: 2, title: 'Hit 10K', description: 'Lock in 10K/day with enjoyable routes', weeks: [3, 4], focusAreas: ['Pace variety', 'Nature walks', 'Incidental steps'] },
    ],
    weeks: [
      {
        week: 1,
        title: 'Week 1 - Baseline & Build',
        description: 'Get comfortable walking daily. Target: 5-6K steps.',
        days: [
          { day: 1, title: 'Monday - Baseline Walk', description: 'Morning walk to set the rhythm', duration: '35 min', activities: ['10 min Hip Circles warm-up', '25 min Walking at easy pace', 'Hydrate and log steps'] },
          { day: 2, title: 'Tuesday - Lunchtime Walk', description: 'Break up your workday', duration: '40 min', activities: ['20 min Walking after lunch', '15 min Walking after dinner', '5 min Standing Hamstring Stretch'] },
          { day: 3, title: 'Wednesday - Brisk Block', description: 'Slightly faster pace', duration: '45 min', activities: ['5 min Hip Circles', '30 min Walking at brisk pace', '10 min Standing Hamstring Stretch cooldown'] },
          { day: 4, title: 'Thursday - Podcast Walk', description: 'Make it enjoyable', duration: '40 min', activities: ['35 min Walking while listening to podcast', '5 min Standing Hamstring Stretch'] },
          { day: 5, title: 'Friday - Nature Route', description: 'Pick a greener route', duration: '45 min', activities: ['40 min Walking through park or trail', '5 min Butterfly Stretch on a bench'] },
          { day: 6, title: 'Saturday - Long Walk', description: 'Longest walk of the week', duration: '60 min', activities: ['50 min Walking continuous', '10 min Standing Hamstring Stretch + Butterfly Stretch'] },
          { day: 0, title: 'Sunday - Easy Recovery', description: 'Gentle stroll with stretching', duration: '30 min', activities: ['20 min Walking easy pace', '10 min Cat-Cow + Child\'s Pose + Butterfly Stretch'] },
        ],
      },
      {
        week: 2,
        title: 'Week 2 - 7K Consistency',
        description: 'Hit 7,000 steps daily. Introduce short bursts.',
        days: [
          { day: 1, title: 'Monday - Intervals', description: 'Add pace changes', duration: '45 min', activities: ['5 min Hip Circles', '3 x (5 min brisk Walking + 5 min easy)', '5 min High Knee Run (30 sec on, 30 sec walk, 5 rounds)', '5 min Standing Hamstring Stretch'] },
          { day: 2, title: 'Tuesday - Steady Zone 2', description: 'Conversational pace all the way', duration: '45 min', activities: ['45 min Walking at steady pace (can hold conversation)'] },
          { day: 3, title: 'Wednesday - Stairs Day', description: 'Find stairs or hills', duration: '40 min', activities: ['5 min Hip Circles', '30 min Walking with 2-3 staircase or hill efforts', '5 min Standing Hamstring Stretch'] },
          { day: 4, title: 'Thursday - Split Walks', description: 'Two shorter walks', duration: '50 min', activities: ['25 min Walking AM', '25 min Walking PM'] },
          { day: 5, title: 'Friday - Social Walk', description: 'Walk with a friend', duration: '50 min', activities: ['50 min Walking while chatting'] },
          { day: 6, title: 'Saturday - Long Walk', description: 'Build distance', duration: '70 min', activities: ['60 min Walking outdoors', '10 min Standing Hamstring Stretch + Butterfly Stretch'] },
          { day: 0, title: 'Sunday - Mobility Stroll', description: 'Walk + mobility', duration: '35 min', activities: ['20 min Walking easy', '15 min Cat-Cow + Child\'s Pose + Hip Circles'] },
        ],
      },
      {
        week: 3,
        title: 'Week 3 - Break 10K',
        description: 'Hit 10,000 steps at least 4 days.',
        days: [
          { day: 1, title: 'Monday - Big Walk', description: 'Front-load the week', duration: '75 min', activities: ['5 min Hip Circles', '65 min Walking briskly', '5 min Standing Hamstring Stretch'] },
          { day: 2, title: 'Tuesday - Steady 10K', description: 'Split into 2-3 walks', duration: '75 min', activities: ['30 min Walking AM', '25 min Walking lunch', '20 min Walking evening'] },
          { day: 3, title: 'Wednesday - Run/Walk', description: 'Sprinkle light running', duration: '45 min', activities: ['5 min Hip Circles', '35 min alternating Walking 4 min / Running 1 min', '5 min Standing Hamstring Stretch'] },
          { day: 4, title: 'Thursday - Commute Walk', description: 'Walk part of commute', duration: '60 min', activities: ['60 min Walking to/from work or errands'] },
          { day: 5, title: 'Friday - Pace Play', description: 'Fartlek style', duration: '50 min', activities: ['5 min Hip Circles', '40 min Walking with random 1-2 min faster bursts', '5 min Standing Hamstring Stretch'] },
          { day: 6, title: 'Saturday - Nature Long Walk', description: 'Hit 12-15K steps', duration: '90 min', activities: ['80 min Walking trail or park', '10 min Butterfly Stretch + Standing Hamstring Stretch'] },
          { day: 0, title: 'Sunday - Yoga Walk Combo', description: 'Walk + stretch', duration: '45 min', activities: ['25 min Walking easy', '20 min Cat-Cow + Child\'s Pose + Butterfly Stretch + Happy Baby Pose'] },
        ],
      },
      {
        week: 4,
        title: 'Week 4 - Lock It In',
        description: 'Hit 10K daily. This is your new normal.',
        days: [
          { day: 1, title: 'Monday - 10K Flow', description: 'Break into 3 walks', duration: '75 min', activities: ['25 min Walking AM', '25 min Walking lunch', '25 min Walking evening'] },
          { day: 2, title: 'Tuesday - Hills', description: 'Add incline', duration: '60 min', activities: ['5 min Hip Circles', '50 min Walking with hill or stair intervals', '5 min Standing Hamstring Stretch'] },
          { day: 3, title: 'Wednesday - Easy Zone 2', description: 'Recovery pace', duration: '70 min', activities: ['70 min Walking at conversational pace'] },
          { day: 4, title: 'Thursday - Run/Walk Builder', description: 'More running intervals', duration: '50 min', activities: ['5 min Hip Circles', '40 min alternating Walking 3 min / Running 2 min', '5 min Standing Hamstring Stretch'] },
          { day: 5, title: 'Friday - Social Steps', description: 'Walk with someone', duration: '60 min', activities: ['60 min Walking with friend or family'] },
          { day: 6, title: 'Saturday - Adventure Walk', description: 'Explore a new route', duration: '90 min', activities: ['80 min Walking exploring new area', '10 min Butterfly Stretch + Child\'s Pose'] },
          { day: 0, title: 'Sunday - Gratitude Walk', description: 'Slow mindful walk', duration: '45 min', activities: ['30 min Walking slowly and mindfully', '15 min Cat-Cow + Child\'s Pose + Happy Baby Pose'] },
        ],
      },
    ],
    dailyStructure: 'DAILY STRUCTURE:\n\n• Morning: 15-25 min walk (kickstarts metabolism)\n• Lunch: 15-20 min walk (improves afternoon focus)\n• Evening: 20-30 min walk (aids digestion & sleep)\n\nTIPS:\n• Always start with Hip Circles for 2-3 min\n• End with Standing Hamstring Stretch to prevent tightness\n• Aim for conversational pace 80% of the time, brisk 20%',
    exerciseGifs: {
      'Walking': 'https://fitnessprogramer.com/wp-content/uploads/2021/09/Walking.gif',
      'Running': 'https://fitnessprogramer.com/wp-content/uploads/2021/07/Run.gif',
      'High Knee Run': 'https://fitnessprogramer.com/wp-content/uploads/2021/08/High-Knee-Run.gif',
      ...
      "Child's Pose": 'https://fitnessprogramer.com/wp-content/uploads/2022/05/Balasana-Child-Pose.gif',
      'Happy Baby Pose': 'https://fitnessprogramer.com/wp-content/uploads/2022/12/Happy-Baby-Pose.gif',
    },
    exerciseFormGuides: {
      'Walking': {
        musclesWorked: ['Quads', 'Glutes', 'Hamstrings', 'Calves', 'Core'],
        setup: 'Stand tall with shoulders relaxed and down, chest open, gaze 10-20 ft ahead. Arms bent at 90°. Feet under hips.',
        steps: [
          'Strike the ground with your heel first',
          'Roll through the foot to push off with your toes',
          'Swing arms naturally - opposite arm to opposite leg',
          'Keep core gently engaged and spine tall',
          'Breathe steadily through nose when possible',
          'Aim for 100-120 steps per minute (brisk pace)',
        ],
        commonMistakes: [
          'Looking at phone - strains the neck and collapses posture',
          'Shuffling feet - reduces calorie burn and glute activation',
          'Over-striding - overloads the knees',
          'Tense shoulders - causes upper back fatigue',
          'Holding weights in hands - wrecks shoulder mechanics',
        ],
        tips: [
          'Walk briskly enough that conversation is possible but singing is not',
          'Use a podcast or audiobook to stretch your walk longer',
          'Walk outdoors when possible - sunlight boosts mood and vitamin D',
          'Replace 1 sitting meeting per day with a walking meeting',
        ],
      },
      'Running': {
        musclesWorked: ['Quads', 'Hamstrings', 'Glutes', 'Calves', 'Core'],
        setup: 'Stand tall, chest up, eyes forward. Start with a slow jog for 60-90 seconds before picking up pace.',
        steps: [
          'Land on your mid-foot, not your heel',
          'Keep cadence quick - aim for 170-180 steps/min',
          'Lean slightly forward from the ankles, not the waist',
          'Relax hands - imagine holding a crisp you don\'t want to crush',
          'Drive elbows backward - arms should not cross the body',
          'Breathe in 3 steps, out 2 (or whatever feels natural)',
        ],
        commonMistakes: [
          'Overstriding - reaching feet too far in front causes braking force',
          'Heel striking hard - raises injury risk',
          'Looking down at the floor - tightens the neck',
          'Clenched fists and tight shoulders - wastes energy',
          'Going too fast too early - blow up before you warm up',
        ],
        tips: [
          'Start with run/walk intervals (1:1 or 2:1) and build up',
          'Invest in proper running shoes from a running shop fitting',
          'Run on soft surfaces (trails, grass) when you can',
          'Hydrate before, and cool down with stretching',
        ],
      },
      'High Knee Run': {
        musclesWorked: ['Hip Flexors', 'Quads', 'Calves', 'Core'],
        setup: 'Stand tall, feet hip-width apart, arms bent at 90° like you\'re about to run.',
        steps: [
          'Drive one knee up toward hip level',
          'As it comes down, drive the other knee up',
          'Stay on the balls of your feet',
          'Pump your arms in sync with your knees',
          'Keep the torso tall - do not lean back',
          'Land softly, don\'t pound the floor',
        ],
        commonMistakes: [
          'Leaning back - strains the lower back',
          'Low knees - it becomes a jog, not high knees',
          'Stiff arms - you lose rhythm',
          'Landing flat-footed - hammers the joints',
        ],
        tips: [
          'Aim for 20-30 seconds on, 20-30 off',
          'Perfect warmup move before brisk walking or running',
          'Great substitute for a treadmill when stuck indoors',
        ],
      },
      'Hip Circles': {
        musclesWorked: ['Hip Flexors', 'Glutes', 'Lower Back', 'Core'],
        setup: 'Stand with feet shoulder-width apart, hands on hips, core gently braced.',
        steps: [
          'Start by pushing hips forward',
          'Circle them to the right side',
          'Then backward (gentle squeeze of glutes)',
          'Then to the left side and back to forward',
          'Make the circles as large as comfortable',
          'Do 8-10 reps each direction',
        ],
        commonMistakes: [
          'Tiny circles - you get no mobility benefit',
          'Moving the whole torso - only the hips should rotate',
          'Holding breath - breathe slowly throughout',
        ],
        tips: [
          'Use before every walk to unlock stiff hips',
          'Pair with ankle circles and shoulder rolls for a full warmup',
          'Great office break when you\'ve been sitting too long',
        ],
      },
      'Standing Hamstring Stretch': {
        musclesWorked: ['Hamstrings', 'Calves', 'Lower Back'],
        setup: 'Stand tall with feet together. Step one foot forward with the heel on the ground and toes lifted.',
        steps: [
          'Hinge at the hips, keeping your back flat',
          'Reach toward the lifted toes',
        ...
        commonMistakes: [
          'Rounding the lower back - this kills the hamstring stretch',
          'Bouncing - gentle static holds are safer',
          'Locking the front knee - slight softness protects the joint',
        ],
        tips: [
          'Do this after every walk to prevent tight hamstrings',
          'Hold longer (45-60s) for real flexibility gains',
          'Breathe into the stretch - exhale a little deeper each time',
        ],
      },
      'Butterfly Stretch': {
        musclesWorked: ['Inner Thighs (Adductors)', 'Hips', 'Groin', 'Lower Back'],
        setup: 'Sit on the floor with spine tall. Bring the soles of your feet together and let your knees fall out to the sides.',
        steps: [
          'Hold your feet or ankles with your hands',
          'Sit up as tall as possible',
          'Gently press knees toward the floor',
          'Hinge forward from the hips (not the back)',
          'Hold for 30-60 seconds',
          'Breathe steadily',
        ],
        commonMistakes: [
          'Rounding the back - keep the spine long',
          'Forcing knees down - let gravity do the work',
          'Pulling hard on the feet - creates tension, not release',
        ],
        tips: [
          'Great cooldown for walkers and runners',
          'Perfect while watching TV in the evening',
          'Combine with deep breathing for extra relaxation',
        ],
      },
      'Cat-Cow': {
        musclesWorked: ['Spine', 'Core', 'Shoulders', 'Hips'],
        setup: 'On hands and knees (tabletop). Hands under shoulders, knees under hips, spine neutral.',
        steps: [
          'Inhale: drop belly, lift chest and tailbone (Cow)',
          'Exhale: round spine, tuck chin and tailbone (Cat)',
          'Move slowly with the breath',
          'Repeat for 6-10 rounds',
          'Keep weight evenly spread across hands and knees',
        ],
        commonMistakes: [
          'Rushing through reps - this is a breath-led movement',
          'Hyperextending elbows - keep a micro-bend',
          'Letting shoulders collapse - actively push the floor away',
        ],
        tips: [
          'Best move to wake up a stiff spine in the morning',
          'Use between sitting sessions at your desk',
          'Pair with Child\'s Pose for a full back reset',
        ],
      },
      "Child's Pose": {
        musclesWorked: ['Lower Back', 'Hips', 'Shoulders'],
        setup: 'Kneel on the floor, big toes touching, knees slightly wider than hips. Sit back on heels.',
        steps: [
          'Fold forward, laying your torso between your thighs',
          'Extend arms forward with palms down',
          'Rest forehead on the mat',
          'Breathe slowly into the back ribs',
          'Hold 30-90 seconds',
        ],
        commonMistakes: [
          'Forcing hips all the way down - rest them on a block or fist if tight',
          'Tensing shoulders - let them melt toward the floor',
          'Holding breath - the magic is in the slow exhales',
        ],
        tips: [
          'Use anytime you feel stressed - it\'s instantly calming',
          'Great restorative pose between more active yoga poses',
          'Place a pillow under belly for extra comfort',
        ],
      },
      'Happy Baby Pose': {
        musclesWorked: ['Hips', 'Inner Thighs', 'Lower Back'],
        setup: 'Lie on your back. Bend your knees into your chest.',
        steps: [
          'Grab the outsides of your feet (or ankles if tight)',
          'Open knees slightly wider than torso',
          'Pull feet down so shins are perpendicular to the floor',
          'Keep lower back on the floor',
          'Rock side to side gently for a massage effect',
          'Hold 30-60 seconds',
        ],
        commonMistakes: [
          'Lifting head and shoulders off the floor - keep them relaxed',
          'Pulling too hard on feet - creates tension',
          'Letting lower back lift - keep ribs heavy',
        ],
        tips: [
          'Perfect end-of-day hip opener',
          'Use after long drives or flights',
  ...
  },
  {
    ...
    tags: ['yoga', 'flexibility', 'wellness', 'stretching', 'bodyweight'],
    createdAt: new Date(Date.now() - 18 * 24 * 60 * 60 * 1000).toISOString(),
    goalType: 'progressive',
    targetAudience: 'Great for beginners and all ages',
    mainGoal: 'Build a 20-min daily yoga practice that unlocks mobility and calms the mind',
    longDescription: 'A guided 4-week progression that takes you from first-time yogi to someone who can flow through sun salutations with confidence. Each session mixes mobility, strength, and breathwork.',
    benefits: [
      'Increase flexibility in hips, hamstrings and spine within 3 weeks',
      'Reduce back pain and morning stiffness',
      'Improve posture and core stability',
      'Lower cortisol and stress levels',
      'Better focus and mood through breathwork',
      'Build whole-body bodyweight strength',
    ],
    equipment: ['Yoga mat', 'Comfortable clothing', 'Optional: block + strap', 'Quiet space'],
    prerequisites: ['No experience needed', 'Work within pain-free ranges', 'Pregnant or injured? Check with your doctor'],
    scientificBacking: 'Harvard Health: 12 weeks of yoga reduces chronic low back pain as effectively as physical therapy. Johns Hopkins: regular yoga lowers anxiety scores by 30%.',
    programLength: '4 weeks',
    phases: [
      { phase: 1, title: 'Foundations', description: 'Learn the core poses and breath', weeks: [1, 2], focusAreas: ['Alignment', 'Breath-to-movement', 'Consistency'] },
      { phase: 2, title: 'Flow', description: 'Link poses into a smooth sequence', weeks: [3, 4], focusAreas: ['Sun salutation', 'Standing balances', 'Deeper stretches'] },
    ],
    weeks: [
      {
        week: 1,
        title: 'Week 1 - Foundations',
        description: 'Learn the anchor poses. 20 min, 4 days this week.',
        days: [
          { day: 1, title: 'Monday - Wake Up Flow', description: 'Wake the spine and hips', duration: '20 min', activities: ['2 min seated breathing', '5 min Cat-Cow', '5 min Downward-Facing Dog (3 holds)', "3 min Child's Pose", '5 min Butterfly Stretch'] },
          { day: 3, title: 'Wednesday - Gentle Opener', description: 'Unlock stiff areas', duration: '20 min', activities: ['3 min Cat-Cow', '4 min Cow Pose + Cat-Cow', '4 min Cobra Stretch', '4 min Happy Baby Pose', '5 min Child\'s Pose'] },
          { day: 5, title: 'Friday - Standing Basics', description: 'Intro to standing poses', duration: '20 min', activities: ['2 min Mountain Pose breathing', '5 min Warrior 1 Pose (both sides)', '5 min Warrior 2 Pose', '4 min Standing Hamstring Stretch', '4 min Child\'s Pose'] },
          { day: 0, title: 'Sunday - Restorative', description: 'Slow and calming', duration: '25 min', activities: ['5 min Cat-Cow', '5 min Bridge Pose', '5 min Happy Baby Pose', '5 min Butterfly Stretch', '5 min Child\'s Pose'] },
        ],
      },
      {
        week: 2,
        title: 'Week 2 - Build Strength',
        description: 'Add holds and intro to chaturanga.',
        days: [
          { day: 1, title: 'Monday - Core + Flow', description: 'Fire up the core', duration: '20 min', activities: ['3 min Cat-Cow', '4 min Plank (30s on, 30s off x 4)', '5 min Chaturanga Dandasana (knees if needed)', '4 min Downward-Facing Dog', '4 min Child\'s Pose'] },
          { day: 3, title: 'Wednesday - Warrior Flow', description: 'Standing power poses', duration: '20 min', activities: ['3 min Mountain Pose', '5 min Warrior 1 Pose', '5 min Warrior 2 Pose', '4 min Warrior 3 Pose', '3 min Standing Hamstring Stretch'] },
          { day: 5, title: 'Friday - Hip Mobility', description: 'Deep hip openers', duration: '22 min', activities: ['3 min Hip Circles', '5 min Butterfly Stretch', '5 min Happy Baby Pose', '5 min Bridge Pose', '4 min Child\'s Pose'] },
          { day: 0, title: 'Sunday - Backbend Day', description: 'Open the chest', duration: '20 min', activities: ['4 min Cat-Cow', '5 min Cobra Stretch', '5 min Bridge Pose', '3 min Ustrasana (Camel Pose)', '3 min Child\'s Pose'] },
        ],
      },
      {
        week: 3,
        title: 'Week 3 - Sun Salutations',
        description: 'Link everything into a flow.',
        days: [
          { day: 1, title: 'Monday - Sun A', description: '5 rounds of Sun A', duration: '22 min', activities: ['3 min breathing', '4 min Mountain Pose to Standing Hamstring Stretch', '5 min Plank + Chaturanga Dandasana', '5 min Cobra Stretch + Downward-Facing Dog', '5 min Child\'s Pose'] },
          { day: 3, title: 'Wednesday - Sun B', description: 'Add warrior poses', duration: '25 min', activities: ['3 min Cat-Cow', '5 min Warrior 1 Pose', '5 min Warrior 2 Pose', '5 min Downward-Facing Dog', '4 min Triangle Pose', '3 min Child\'s Pose'] },
          { day: 5, title: 'Friday - Balance Flow', description: 'Work on standing balance', duration: '22 min', activities: ['3 min Mountain Pose', '5 min Warrior 3 Pose', '5 min Triangle Pose', '5 min Happy Baby Pose', '4 min Butterfly Stretch'] },
          { day: 0, title: 'Sunday - Full Flow', description: 'Put it all together', duration: '30 min', activities: ['3 min breathing', '5 min Cat-Cow + Cobra Stretch', '5 min Warrior 1 Pose + Warrior 2 Pose', '5 min Triangle Pose', '5 min Bridge Pose + Happy Baby Pose', '7 min Child\'s Pose + Butterfly Stretch'] },
        ],
      },
      {
        week: 4,
        title: 'Week 4 - Confident Flow',
        description: 'Own your practice.',
        days: [
          { day: 1, title: 'Monday - Power Flow', description: 'Strong + sweaty', duration: '25 min', activities: ['3 min Cat-Cow', '5 min Plank + Chaturanga Dandasana', '5 min Warrior 1 Pose + Warrior 2 Pose', '5 min Downward-Facing Dog holds', '4 min Cobra Stretch', '3 min Child\'s Pose'] },
          { day: 3, title: 'Wednesday - Hip + Backbend', description: 'Open the front body', duration: '25 min', activities: ['3 min Hip Circles', '5 min Bridge Pose', '5 min Ustrasana (Camel Pose)', '5 min Cobra Stretch', '4 min Happy Baby Pose', '3 min Child\'s Pose'] },
          { day: 5, title: 'Friday - Balance + Twist', description: 'Total body flow', duration: '25 min', activities: ['3 min Mountain Pose', '5 min Warrior 3 Pose', '5 min Triangle Pose', '5 min Standing Hamstring Stretch', '4 min Butterfly Stretch', '3 min Child\'s Pose'] },
          { day: 0, title: 'Sunday - Long Restore', description: 'Reward yourself with a long restorative session', duration: '35 min', activities: ['5 min breathing + Cat-Cow', '5 min Cow Pose', '5 min Bridge Pose', '5 min Happy Baby Pose', '5 min Butterfly Stretch', '10 min Child\'s Pose with deep breathing'] },
        ],
      },
    ],
    dailyStructure: 'DAILY STRUCTURE:\n\n1. 2-3 min breathing to settle in\n2. 5 min warmup (Cat-Cow, Hip Circles)\n3. 8-10 min main flow (standing poses or sun salutations)\n4. 5 min stretches (hamstring, butterfly, happy baby)\n5. 2-3 min Child\'s Pose to close\n\nDo this 4x/week minimum. More if you love it.',
    exerciseGifs: {
      'Cat-Cow': 'https://fitnessprogramer.com/wp-content/uploads/2021/02/cat-cow.gif',
      'Cow Pose': 'https://fitnessprogramer.com/wp-content/uploads/2022/05/Bitilasana-Cow-Pose.gif',
      "Child's Pose": 'https://fitnessprogramer.com/wp-content/uploads/2022/05/Balasana-Child-Pose.gif',
      'Bridge Pose': 'https://fitnessprogramer.com/wp-content/uploads/2022/05/Bridge-Pose.gif',
      'Cobra Stretch': 'https://fitnessprogramer.com/wp-content/uploads/2021/06/abdominal-stretch.gif',
      'Mountain Pose': 'https://fitnessprogramer.com/wp-content/uploads/2022/05/Tadasana-Mountain-Pose.gif',
      'Warrior 1 Pose': 'https://fitnessprogramer.com/wp-content/uploads/2023/01/Warrior-1-Pose.gif',
      'Warrior 2 Pose': 'https://fitnessprogramer.com/wp-content/uploads/2023/01/Warrior-2-Pose.gif',
      'Warrior 3 Pose': 'https://fitnessprogramer.com/wp-content/uploads/2023/01/Warrior-3-Pose.gif',
      'Triangle Pose': 'https://fitnessprogramer.com/wp-content/uploads/2023/01/Utthita-Trikonasana-Extended-Triangle-Pose.gif',
      'Ustrasana': 'https://fitnessprogramer.com/wp-content/uploads/2023/01/Ustrasana.gif',
      'Happy Baby Pose': 'https://fitnessprogramer.com/wp-content/uploads/2022/12/Happy-Baby-Pose.gif',
      'Butterfly Stretch': 'https://fitnessprogramer.com/wp-content/uploads/2021/02/Butterfly-Stretch.gif',
      'Standing Hamstring Stretch': 'https://fitnessprogramer.com/wp-content/uploads/2021/05/Standing-Hamstring-Stretch.gif',
      'Hip Circles': 'https://fitnessprogramer.com/wp-content/uploads/2021/01/hip-circles.gif',
      'Plank': 'https://fitnessprogramer.com/wp-content/uploads/2021/02/plank.gif',
      'Chaturanga Dandasana': 'https://fitnessprogramer.com/wp-content/uploads/2022/05/Chaturanga-Dandasana-Low-Plank-Pose.gif',
      'Downward-Facing Dog': 'https://fitnessprogramer.com/wp-content/uploads/2022/05/Chaturanga-Dandasana-Low-Plank-Pose.gif',
    },
    exerciseFormGuides: {
      'Cat-Cow': {
        musclesWorked: ['Spine', 'Core', 'Shoulders', 'Hips'],
        setup: 'Start on hands and knees. Wrists under shoulders, knees under hips, neutral spine.',
        steps: [
          'Inhale: drop belly, lift chest and tailbone toward the sky (Cow)',
          'Exhale: round the spine, tuck the chin to chest (Cat)',
          'Move slowly with your breath',
          'Repeat for 6-10 full rounds',
        ],
        commonMistakes: [
          'Rushing through - breath should lead movement',
          'Hyperextending elbows - keep a soft bend',
          'Letting shoulders collapse - press the floor away',
        ],
        tips: [
          'The #1 move to wake up a stiff spine',
          'Use any time you\'ve been sitting for too long',
          'Pair with Child\'s Pose to close out',
        ],
      },
      "Child's Pose": {
        musclesWorked: ['Lower Back', 'Hips', 'Shoulders'],
        setup: 'Kneel with big toes touching and knees slightly wider than hips. Sit back on heels.',
        steps: [
        ...
        commonMistakes: [
          'Forcing hips to heels - rest on a block if tight',
          'Tensing shoulders - melt them down',
          'Shallow breathing - make exhales long',
        ],
        tips: [
          'Universal reset pose - use any time',
          'Amazing for stress and anxiety',
          'Add a bolster or pillow for extra support',
        ],
      },
      'Downward-Facing Dog': {
        musclesWorked: ['Shoulders', 'Hamstrings', 'Calves', 'Core', 'Back'],
        setup: 'From hands and knees, tuck toes, lift hips up and back.',
        steps: [
          'Press palms firmly into the mat, spread fingers wide',
          'Drive hips up and back to make an inverted V',
          'Let heels move toward the floor (don\'t force them down)',
          'Relax the head between the arms',
          'Engage the core to protect the lower back',
          'Hold for 5-8 slow breaths',
        ],
        commonMistakes: [
          'Rounding the upper back - lengthen the spine',
          'Locking elbows - keep micro-bend',
          'Forcing heels down - they don\'t need to touch',
          'Collapsing shoulders - actively push floor away',
        ],
        tips: [
          'Bend knees a lot at first to protect the back',
          'Pedal the feet to warm up the calves',
          'This is a resting pose, not a stress pose - breathe',
        ],
      },
      'Mountain Pose': {
        musclesWorked: ['Core', 'Legs', 'Spine', 'Postural Muscles'],
        setup: 'Stand with feet together or hip-width apart. Weight evenly on both feet.',
        steps: [
          'Root down through all four corners of each foot',
          'Engage quads lightly - lift kneecaps',
          'Draw tailbone down, belly gently in',
          'Roll shoulders up, back, and down',
          'Arms rest at sides, palms forward',
          'Crown of head reaches upward',
          'Hold for 5-10 long breaths',
        ],
        commonMistakes: [
          'Locking the knees - creates tension',
          'Sticking the ribs out - keep them soft',
          'Looking at the floor - eyes soft and forward',
        ],
        tips: [
          'Looks simple, feels powerful when done right',
          'This is the foundation of every standing pose',
          'Sneak it into your day: waiting in line, at the sink',
        ],
      },
      'Warrior 1 Pose': {
        musclesWorked: ['Quads', 'Glutes', 'Hip Flexors', 'Shoulders', 'Core'],
        setup: 'Step one foot back 3-4 feet. Back foot at 45°, front foot pointing forward. Hips squared forward.',
        steps: [
          'Bend the front knee to 90° over the ankle',
          'Keep the back leg straight and strong',
          'Square your hips toward the front',
          'Lift arms overhead, shoulders relaxed',
          'Lift chest, gaze forward or slightly up',
          'Hold for 5-8 breaths, then switch sides',
        ],
        commonMistakes: [
          'Front knee caving inward - track it over the middle toe',
          'Back foot lifting - press the outer edge down',
          'Shrugging shoulders - drop them away from ears',
          'Arching the lower back - tuck tailbone slightly',
        ],
        tips: [
          'Strong and energizing - great for mornings',
          'Keep the stance long enough that knee is over ankle',
          'Breathe steadily - don\'t hold your breath',
        ],
      },
      'Warrior 2 Pose': {
        musclesWorked: ['Quads', 'Glutes', 'Inner Thighs', 'Shoulders', 'Core'],
        setup: 'From a wide stance, front foot forward, back foot parallel to the back edge of the mat.',
        steps: [
          'Bend the front knee to 90° over the ankle',
          'Straighten the back leg, press outer edge of foot down',
          'Extend arms parallel to the floor',
          'Gaze over the front hand',
          'Open hips and chest toward the side',
          'Hold for 5-8 breaths, switch',
        ],
        commonMistakes: [
          'Front knee falling inward - drive it toward the pinky toe',
          'Leaning forward - stack torso over the hips',
          'Shoulders creeping up - relax them down',
        ],
        tips: [
          'Sink low enough that the front thigh is parallel',
          'Feel grounded like a warrior - steady breath',
          'Energizing and empowering',
        ],
      },
      'Warrior 3 Pose': {
        musclesWorked: ['Glutes', 'Hamstrings', 'Core', 'Back', 'Shoulders'],
        setup: 'Start standing. Shift weight onto one leg.',
        steps: [
          'Hinge forward at the hips',
          'Extend the back leg straight behind you',
          'Reach arms forward or back by sides',
          'Make a T-shape with your body',
          'Keep standing leg firm with a micro-bend',
          'Hold for 3-5 breaths, switch sides',
        ],
        commonMistakes: [
          'Lifted leg turns out - keep hip squared down',
          'Rounding the back - keep spine long',
          'Wobbling hard - use a wall or chair at first',
        ],
        tips: [
          'Fix your gaze on one unmoving point',
          'Build up hold time gradually',
          'Great for balance and glute activation',
        ],
      },
      'Triangle Pose': {
        musclesWorked: ['Hamstrings', 'Hips', 'Obliques', 'Shoulders'],
        setup: 'Wide stance, front foot forward, back foot at 90° to the side.',
        steps: [
          'Straighten both legs',
          'Extend the front arm forward, then hinge at the hip',
          'Lower front hand to shin, block, or floor',
          'Top arm reaches straight up',
          'Open chest, gaze up at top hand',
          'Hold for 5-8 breaths, switch',
        ],
        commonMistakes: [
          'Rounding over the front leg - lead with the chest',
          'Locking the front knee hard - slight softness',
          'Collapsing chest downward - keep it rotated up',
        ],
        tips: [
          'Use a block under the bottom hand if you can\'t reach',
          'Think of being between two panes of glass',
          'Amazing stretch for the whole side body',
        ],
      },
      'Cobra Stretch': {
        musclesWorked: ['Lower Back', 'Abs', 'Chest', 'Shoulders'],
        setup: 'Lie face down with hands under shoulders, elbows close to ribs, legs extended.',
        steps: [
          'Press the tops of feet into the floor',
          'Inhale and gently lift chest off the floor',
          'Keep elbows slightly bent',
          'Draw shoulder blades down and back',
          'Lift to where you feel a nice stretch, not pain',
          'Hold 15-30 seconds, lower slowly',
        ],
        commonMistakes: [
          'Jamming into the lower back - lift with back strength, not hands',
          'Scrunching shoulders to ears - keep them away',
          'Locking elbows - keep a slight bend',
        ],
        tips: [
          'Perfect counter-pose to sitting all day',
          'Great after crunches or plank work',
          'Breathe deeply into the chest as it lifts',
        ],
      },
      'Bridge Pose': {
        musclesWorked: ['Glutes', 'Hamstrings', 'Lower Back', 'Core'],
        setup: 'Lie on your back with knees bent, feet flat on floor hip-width apart.',
        steps: [
          'Arms at sides, palms down',
          'Press feet into the floor',
          'Squeeze glutes and lift hips',
          'Aim for shoulders-hips-knees in a line',
          'Hold for 5-8 breaths',
          'Lower slowly, one vertebra at a time',
        ],
        commonMistakes: [
          'Over-arching lower back - lift from glutes, not back',
          'Feet too far from body - keep them close to glutes',
          'Knees flaring out - track them over ankles',
        ],
        tips: [
          'Great for a sore lower back and tight hips',
          'Clasp hands under body for a shoulder stretch too',
          'Progress to single-leg bridge when easy',
        ],
      },
      'Happy Baby Pose': {
        musclesWorked: ['Hips', 'Inner Thighs', 'Lower Back'],
        setup: 'Lie on your back. Bend knees into your chest.',
        steps: [
          'Grab the outsides of your feet (or ankles)',
          'Open knees slightly wider than torso',
          'Pull feet down so shins are vertical',
          'Press lower back into the floor',
          'Rock side to side gently',
          'Hold for 30-60 seconds',
        ],
        commonMistakes: [
          'Head lifting off the floor - keep it relaxed',
          'Pulling feet too hard - creates tension',
          'Lower back arching - keep ribs heavy',
        ],
        tips: [
          'Excellent end-of-session hip release',
          'Use it to calm the nervous system',
          'Breathe deeply into the belly',
        ],
      },
      'Butterfly Stretch': {
        musclesWorked: ['Inner Thighs', 'Hips', 'Groin', 'Lower Back'],
        setup: 'Sit tall, soles of feet together, knees falling out.',
        steps: [
          'Hold ankles or feet',
          'Sit up straight - no rounded back',
          'Gently press knees toward the floor',
          'Hinge forward from hips, not waist',
          'Hold 30-60 seconds',
        ],
        commonMistakes: [
          'Rounding the spine - keep it long',
          'Bouncing knees - gentle static hold',
          'Forcing knees down - let gravity work',
        ],
        tips: [
          'Ideal cooldown for any workout',
      ...
      'Standing Hamstring Stretch': {
        musclesWorked: ['Hamstrings', 'Calves', 'Lower Back'],
        setup: 'Stand tall. Step one foot forward with heel down, toes up.',
        steps: [
          'Hinge at hips with flat back',
          'Reach toward lifted toes',
          'Keep front leg straight but not locked',
          'Feel the stretch along the back of the leg',
          'Hold 20-30 seconds, switch sides',
        ],
        commonMistakes: [
          'Rounding the lower back - keep spine long',
          'Bouncing - use static holds',
          'Locking knees hard - slight softness',
        ],
        tips: [
          'Perfect post-run or post-walk',
          'Hold longer for real flexibility gains',
          'Breathe deeply into each hold',
        ],
      },
      'Plank': {
        musclesWorked: ['Core', 'Shoulders', 'Chest', 'Quads', 'Glutes'],
        setup: 'Forearms or hands shoulder-width apart. Feet hip-width. Body in a straight line.',
        steps: [
          'Engage core like bracing for a punch',
          'Squeeze glutes',
          'Press shoulders down away from ears',
          'Heels pushing backward',
          'Breathe steadily - no holding',
          'Start with 20-30s, build to 60s',
        ],
        commonMistakes: [
          'Hips sagging - creates lower back strain',
          'Butt in the air - loses core engagement',
          'Holding breath - defeats the purpose',
        ],
        tips: [
          'Quality over quantity - perfect form beats long holds',
          'Drop to knees if form breaks',
          'Foundation for push-ups and many yoga flows',
        ],
      },
      'Chaturanga Dandasana': {
        ...
        steps: [
          'Shift slightly forward on your toes',
          'Bend elbows to 90° keeping them close to ribs',
          'Lower body in one line, not hips first',
          'Shoulders stay at elbow height (not lower)',
          'Hold briefly, then push up or lower down',
        ],
        commonMistakes: [
          'Elbows flaring out wide - keep close to ribs',
          'Shoulders dipping below elbows - stops at 90°',
          'Hips sagging - keep a plank line',
        ],
        tips: [
          'Modify on knees as long as needed',
          'This is harder than it looks - be patient',
          'Build shoulder strength before going low',
        ],
      },
      'Hip Circles': {
        musclesWorked: ['Hip Flexors', 'Glutes', 'Core'],
        setup: 'Stand with feet shoulder-width, hands on hips.',
        steps: [
          'Push hips forward',
          'Circle to the right',
          'Then backward (squeeze glutes)',
          'Then left and back to front',
          'Do 8-10 each direction',
        ],
        commonMistakes: [
          'Tiny circles - make them generous',
          'Moving the whole torso - isolate the hips',
          'Holding breath - breathe steadily',
        ],
        tips: [
          'Awesome 2-minute warmup',
          'Great for stiff office hips',
          'Pair with shoulder rolls',
        ],
      },
      'Ustrasana': {
        musclesWorked: ['Chest', 'Quads', 'Hip Flexors', 'Back'],
        setup: 'Kneel with knees hip-width apart. Shins flat, toes tucked or untucked.',
        steps: [
          'Place hands on lower back, fingers down',
          'Lift chest up and back',
          'Gradually reach hands to heels',
          'Lift hips forward, open chest',
          'Let head fall back only if the neck is comfortable',
          'Hold 5-8 breaths, exit slowly',
        ],
        commonMistakes: [
          'Dumping into lower back - lift chest FIRST',
          'Crunching the neck - keep length',
          'Going too deep too fast - progress gradually',
        ],
        tips: [
          'Counter long hours of sitting',
          'Open heart pose - great for mood',
          'Follow with Child\'s Pose to release back',
        ],
      },
      'Cow Pose': {
        musclesWorked: ['Spine', 'Core', 'Neck', 'Chest'],
        setup: 'Start on hands and knees.',
        steps: [
          'Inhale deeply',
          'Drop belly toward the floor',
          'Lift chest and tailbone up',
          'Gaze gently forward and slightly up',
          'Combine with Cat pose for full flow',
        ],
        commonMistakes: [
          'Crunching the neck - keep length',
          'Overarching lower back - move with control',
        ],
        tips: [
          'Always flow between Cat and Cow',
...
COMMUNITY_HABITS.push(
  ...
  {
    id: 'ch-4day-split',
    name: '4x4 Strength Training',
    description: '4 days/week strength program: 4x4 compounds plus smart arm pairings. Chest+triceps, back+biceps, legs, then arms+shoulders.',
    icon: 'dumbbell',
    color: HABIT_COLORS[3],
    ...
    tags: ['strength', '4x4', 'split', 'gym', 'hypertrophy'],
    createdAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
    goalType: 'progressive',
    targetAudience: 'Intermediate lifters who want strength gains with balanced arm volume and proper push/pull pairings',
    mainGoal: 'Add 20-40 lbs to bench, squat, and deadlift over 12 weeks',
    longDescription: 'A 4-day strength program built around 4x4 sets on main lifts (bench, row/deadlift, squat, overhead press) with a middle-ground split: Mon Chest & Triceps, Tue Back & Biceps, Wed Rest, Thu Legs, Fri Arms & Shoulders. Push muscles stay together for pressing strength; biceps train with back; Friday adds extra arm volume without pairing chest with biceps.',
    benefits: [
      'Build real strength with 4x4 progressive overload on compounds',
      'Chest + triceps pairing for better bench progress',
      'Back + biceps pairing for stronger pulls',
      'Dedicated arms & shoulders day for balanced arm growth',
      '3 rest days for recovery on a 4-day schedule',
      '12-week periodisation from technique to 1RM testing',
    ],
    ...
    scientificBacking: '4x4 loading at 75-85% 1RM builds strength while leaving room for hypertrophy accessories. Pairing chest with triceps and back with biceps matches movement patterns; a fourth arms day adds volume without compromising compound progress.',
    programLength: '12 weeks',
    resources: [
    ...
    phases: [
      {
        ...
        weeks: [1, 2, 3, 4],
        focusAreas: ['4x4 technique', 'Push/pull pairings', 'Recovery baseline'],
      },
      {
        phase: 2,
        ...
        weeks: [5, 6, 7, 8],
        focusAreas: ['4x4 progressive overload', 'Heavier main lifts', 'Accessory volume'],
      },
      {
        phase: 3,
    ...
    dailyStructure: 'WEEKLY STRUCTURE (4 training days):\n\nDAY 1 (MON) - CHEST & TRICEPS\n• Barbell Bench Press: 4x4 @ 75-85% 1RM\n• Incline Dumbbell Press: 3x8\n• Cable Fly: 3x12\n• Tricep Pushdown: 3x12\n• Skull Crushers: 3x10\n\nDAY 2 (TUE) - BACK & BICEPS\n• Barbell Row or Deadlift: 4x4 @ 75-85% 1RM\n• Pull-ups or Lat Pulldown: 3x8\n• Seated Cable Row: 3x10\n• Face Pull: 3x15\n• Barbell Curl: 3x10\n• Hammer Curl: 3x10\n\nDAY 3 (WED) - REST / walk + stretch\n\nDAY 4 (THU) - LEGS\n• Back Squat: 4x4 @ 75-85% 1RM\n• Romanian Deadlift: 3x8\n• Leg Press: 3x10\n• Leg Curl: 3x12\n• Standing Calf Raise: 4x12\n\nDAY 5 (FRI) - ARMS & SHOULDERS\n• Overhead Press: 4x4 @ 72-82% 1RM\n• Lateral Raise: 4x12\n• Face Pull: 3x15\n• Skull Crushers: 3x10\n• Incline Dumbbell Curl: 3x10\n• Hanging Leg Raise: 3x12\n\nDAYS 6-7 - REST\n\nPROGRESSION: Add 2.5-5 lbs when all 4 sets hit 4 reps. Rest 2-3 min on 4x4 sets, 90 sec on accessories.',
    weeks: [
      {
        week: 1,
        title: 'Foundation Week - Learn the 4x4 Split',
        description: 'Moderate 4x4 loads on compounds. Dial in form and push/pull pairings.',
        days: [
          {
            day: 1,
            title: 'Day 1 - Chest & Triceps',
            description: 'Push day — 4x4 bench plus tricep accessories',
            duration: '60 min',
            activities: [
              'Barbell Bench Press: 4x4 @ 72% 1RM',
              'Incline Dumbbell Press: 3x8',
              'Cable Fly: 3x12',
              'Tricep Pushdown: 3x12',
              'Skull Crushers: 3x10',
            ],
            notes: 'Leave 1-2 reps in reserve on bench. Triceps support your press — don’t skip them.',
          },
          {
            day: 2,
            title: 'Day 2 - Back & Biceps',
            description: 'Pull day — 4x4 row plus direct bicep work',
            duration: '65 min',
            activities: [
              'Barbell Row: 4x4 @ 72% 1RM',
              'Lat Pulldown: 3x10',
              'Seated Cable Row: 3x10',
              'Face Pull: 3x15',
              'Barbell Curl: 3x10',
            ...
            notes: 'Initiate pulls with your back. Biceps finish the session — not paired with chest.',
          },
          {
            day: 3,
            title: 'Rest / Mobility',
          ...
          },
          {
            day: 4,
            title: 'Day 3 - Legs',
            description: '4x4 squat focus — hardest session of the week',
            duration: '70 min',
            activities: [
              'Back Squat: 4x4 @ 72% 1RM',
              'Romanian Deadlift: 3x8',
              'Leg Press: 3x10',
              'Leg Curl: 3x12',
              'Standing Calf Raise: 4x12',
            ],
            notes: 'Brace before every squat rep. Rest 2-3 min between 4x4 sets.',
          },
          {
            day: 5,
            title: 'Day 4 - Arms & Shoulders',
            description: 'Middle-ground day — shoulders plus direct arm work',
            duration: '55 min',
            activities: [
              'Overhead Press: 4x4 @ 70% 1RM',
              'Lateral Raise: 4x12',
              'Face Pull: 3x15',
              'Skull Crushers: 3x10',
              'Incline Dumbbell Curl: 3x10',
            ...
            notes: 'Extra arm volume without pairing biceps with chest. Strict lateral raises.',
          },
          {
            day: 6,
            title: 'Rest',
