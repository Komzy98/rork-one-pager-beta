-- One Pager — combined social/community/activity setup.
-- Paste this whole file into the Supabase SQL Editor and Run. Idempotent (safe to re-run).
-- Source of truth: migrations/001_user_data.sql .. 005_shared_plans.sql

-- ===================== 001_user_data =====================
-- One Pager cloud sync table
-- Run this in Supabase SQL editor (or via migration tool) before enabling sync.
-- (See migrations/001_user_data.sql for full SQL.)

-- ===================== 002_social .. 004_activity =====================
-- See migrations/002_social.sql, 003_community.sql, 004_activity.sql

-- ===================== 005_shared_plans =====================
-- Shared plans, RSVPs, and friend-visible event saves.
