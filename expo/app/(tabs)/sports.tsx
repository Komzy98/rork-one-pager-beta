...
export default function SportsScreen() {
  ...
  const liveQuery = trpc.football.getMatches.useQuery(
    ...
    { 
      enabled: sportMode === 'football' && (activeTab === 'live' || hasViewedLive),
      refetchInterval: activeTab === 'live' ? 60000 : false,
      staleTime: 2 * 60 * 1000,
      gcTime: 15 * 60 * 1000,
      retry: 3,
      retryDelay: (attemptIndex: number) => Math.min(2000 * Math.pow(2, attemptIndex), 15000),
  ...
  const upcomingQuery = trpc.football.getMatches.useQuery(
    ...
    { 
      ...
      refetchInterval: activeTab === 'upcoming' ? 10 * 60 * 1000 : false,
  ...
  const resultsQuery = trpc.football.getMatches.useQuery(
    ...
    { 
      ...
      refetchInterval: activeTab === 'results' ? 15 * 60 * 1000 : false,
