...
const styles = StyleSheet.create({
  ...
  heroLabel: { fontSize: 11, fontWeight: '700' as const, letterSpacing: 1.2, marginBottom: 10 },
  ...
  heroBadgeText: { color: '#fff', fontSize: 11, fontWeight: '700' as const },
  heroTitle: { color: '#fff', fontSize: 22, fontWeight: '800' as const, letterSpacing: -0.4, lineHeight: 26 },
  ...
  heroMetaText: { color: 'rgba(255,255,255,0.85)', fontSize: 12, fontWeight: '500' as const },
  ...
  mealPlanSubtitle: { fontSize: 12, paddingHorizontal: 20, marginTop: -4, marginBottom: 10 },
  ...
  mealType: { fontSize: 11, fontWeight: '600' as const, textTransform: 'uppercase' as const, letterSpacing: 0.5 },
  mealRecipe: { fontSize: 15, fontWeight: '600' as const, marginTop: 2 },
  mealCompleted: { textDecorationLine: 'line-through' as const, opacity: 0.5 },
  mealTime: { fontSize: 12, fontWeight: '500' as const, marginRight: 4 },
  ...
  favouriteTitle: { color: '#FFFFFF', fontSize: 14, fontWeight: '700' as const },
  favouriteMeta: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 },
  favouriteMetaText: { color: '#FFFFFF', fontSize: 11, fontWeight: '500' as const },
  ...
  recipeTitle: { fontSize: 16, fontWeight: '700' as const, flex: 1, marginRight: 8 },
  recipeSubtitle: { fontSize: 12, marginTop: 2 },
  recipeMeta: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 8 },
  recipeMetaItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  recipeMetaText: { fontSize: 12, fontWeight: '500' as const },
  recipeDiffBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
  recipeDiffText: { fontSize: 11, fontWeight: '600' as const },
  expandedContent: { borderTopWidth: 1, padding: 14 },
  expandedSection: { marginBottom: 14 },
  expandedLabel: { fontSize: 13, fontWeight: '700' as const, textTransform: 'uppercase' as const, letterSpacing: 0.5, marginBottom: 8 },
  ...
  ingredientText: { fontSize: 12, fontWeight: '500' as const },
  ...
  stepNumberText: { color: '#FFFFFF', fontSize: 11, fontWeight: '700' as const },
  ...
  cookBtnText: { color: '#fff', fontSize: 14, fontWeight: '700' as const },
