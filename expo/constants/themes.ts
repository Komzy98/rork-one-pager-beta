...
const brandLightColors = {
  ...
  primaryLight: BRAND.light.primaryLight,
  primaryDark: BRAND.light.primaryDark,
  success: '#22C55E',
  successLight: '#BBF7D0',
  error: '#EF4444',
  errorLight: '#FECACA',
  warning: '#F59E0B',
  warningLight: '#FDE68A',
  info: BRAND.light.accent,
  infoLight: '#F3E8FF',
  background: BRAND.light.background,
  backgroundSecondary: BRAND.light.backgroundSecondary,
  surface: BRAND.light.surface,
  surfaceSecondary: BRAND.light.surfaceSecondary,
  text: BRAND.light.text,
  textSecondary: BRAND.light.textSecondary,
  textTertiary: BRAND.light.textTertiary,
  textMuted: BRAND.light.textMuted,
  textInverse: BRAND.light.textInverse,
  border: BRAND.light.border,
  borderLight: BRAND.light.borderLight,
  divider: BRAND.light.divider,
  inactive: '#9CA3AF',
  disabled: '#E2E8F0',
  pressed: BRAND.light.pressed,
  ...
  cardElevated: BRAND.light.surface,
  cardSecondary: BRAND.light.surfaceSecondary,
  cardHover: BRAND.light.border,
  secondary: BRAND.light.accent,
  completed: '#22C55E',
  upcoming: '#F59E0B',
  backgroundTertiary: BRAND.light.border,
  gradientStart: BRAND.light.gradientStart,
  gradientMiddle: BRAND.light.gradientMiddle,
  gradientEnd: BRAND.light.gradientEnd,
  tabBarBackground: BRAND.light.surface,
  tabBarBorder: BRAND.light.border,
};

const brandDarkColors = {
  primary: BRAND.dark.primary,
  primaryLight: BRAND.dark.primaryLight,
  primaryDark: BRAND.dark.primaryDark,
  success: '#4ADE80',
  successLight: '#86EFAC',
  error: '#F87171',
  errorLight: '#FCA5A5',
  warning: '#FBBF24',
  warningLight: '#FDE68A',
  info: BRAND.dark.accent,
  infoLight: '#F3E8FF',
  background: BRAND.dark.background,
  backgroundSecondary: BRAND.dark.backgroundSecondary,
  surface: BRAND.dark.surface,
  surfaceSecondary: BRAND.dark.surfaceSecondary,
  text: BRAND.dark.text,
  textSecondary: BRAND.dark.textSecondary,
  textTertiary: BRAND.dark.textTertiary,
  textMuted: BRAND.dark.textMuted,
  textInverse: BRAND.dark.textInverse,
  border: BRAND.dark.border,
  borderLight: BRAND.dark.borderLight,
  divider: BRAND.dark.divider,
  inactive: '#454F63',
  disabled: 'rgba(255, 255, 255, 0.08)',
  pressed: BRAND.dark.pressed,
  ...
  cardElevated: BRAND.dark.surfaceSecondary,
  cardSecondary: BRAND.dark.surfaceSecondary,
  cardHover: BRAND.dark.border,
  secondary: BRAND.dark.accent,
  completed: '#4ADE80',
  upcoming: '#FBBF24',
  backgroundTertiary: BRAND.dark.border,
  gradientStart: BRAND.dark.gradientStart,
  gradientMiddle: BRAND.dark.gradientMiddle,
  gradientEnd: BRAND.dark.gradientEnd,
  tabBarBackground: BRAND.dark.surface,
  tabBarBorder: BRAND.dark.border,
};
